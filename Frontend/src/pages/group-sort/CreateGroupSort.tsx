...
function CreateGroupSort() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-900 via-purple-900 to-blue-900">
      {/* Header */}
      <div className="bg-gray-900/50 backdrop-blur-lg border-b border-purple-500 shadow-lg shadow-purple-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <Typography variant="h3" className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-purple-600 font-mono">Create Group Sort Game</Typography>
      ...
      <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-lg border-2 border-purple-500 shadow-lg shadow-purple-500/20 p-6 space-y-6">
          {/* Basic Info */}
          <div className="space-y-4">
            <Typography variant="h4" className="text-cyan-400 font-mono">Game Information</Typography>
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4 text-cyan-500 border-purple-500 rounded focus:ring-purple-500 bg-gray-700"
                />
                <Label htmlFor="isCategoryRandomized" className="cursor-pointer text-cyan-400">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4 text-cyan-500 border-purple-500 rounded focus:ring-purple-500 bg-gray-700"
                />
                <Label htmlFor="isItemRandomized" className="cursor-pointer text-cyan-400">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4 text-cyan-500 border-purple-500 rounded focus:ring-purple-500 bg-gray-700"
                />
                <Label htmlFor="isPublishImmediately" className="cursor-pointer text-cyan-400">
                  Publish Immediately
                </Label>
              </div>
            </div>
            ...
            <div>
              <Label className="text-cyan-400">Thumbnail Image (Optional)</Label>
              <Dropzone
          ...
          {/* Categories */}
          <div className="space-y-4 pt-6 border-t border-purple-500">
            <div className="flex items-center justify-between">
              <Typography variant="h4" className="text-cyan-400 font-mono">Categories & Items</Typography>
              <Button onClick={addCategory} size="sm" variant="outline" className="text-cyan-400 border-cyan-500 hover:bg-cyan-500/10">
            ...
            {categories.map((category, catIdx) => (
              <div key={catIdx} className="border-2 border-cyan-500 rounded-lg p-4 space-y-4 bg-gray-900/30">
                <div className="flex items-center justify-between">
                  <Label className="text-cyan-400">Category {catIdx + 1}</Label>
                  {categories.length > 2 && (
                    <Button
                      variant="ghost"
                      size="sm"
                ...
                <Input
                  ...
                  className="bg-gray-900/50 border-purple-500 text-cyan-400"
                />

                <div className="space-y-3 pl-4 border-l-2 border-purple-500">
                  <Label className="text-sm text-purple-400">Items</Label>
                    ...
                    <div key={itemIdx} className="flex gap-2 items-start">
                      <div className="flex-1 space-y-2">
                        ...
                        <Input
                          ...
                          className="bg-gray-900/50 border-purple-500 text-cyan-400 placeholder-purple-600/50"
                        />
                      </div>
                      <Button
                        variant="ghost"
                  ...
                  <Button
                    ...
                    className="w-full text-cyan-400 border-cyan-500 hover:bg-cyan-500/10"
                  >
                    <Plus size={16} className="mr-1" />
                    Add Item
                  </Button>
          ...
          <div className="flex gap-4 pt-6">
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button className="flex-1 bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500" disabled={loading}>
                  <SaveIcon size={16} className="mr-2" />
                  {loading ? "Creating..." : "Create Game"}
                </Button>
              </AlertDialogTrigger>
              <AlertDialogContent className="bg-gray-800 border-purple-500">
                <AlertDialogHeader>
                  <AlertDialogTitle className="text-cyan-400">Create Group Sort Game?</AlertDialogTitle>
                  <AlertDialogDescription className="text-purple-400">
                    This will create a new Group Sort game with {categories.length} categories.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel className="text-cyan-400 border-cyan-500">Cancel</AlertDialogCancel>
                  <AlertDialogAction onClick={handleSubmit} className="bg-gradient-to-r from-cyan-500 to-purple-600">
                    Create
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
